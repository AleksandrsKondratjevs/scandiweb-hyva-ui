...
define([
    ...
    "slick",
    "underscore",
    "Magento_PageBuilder/js/binding/focus",
    ...
    var Preview = /*#__PURE__*/ (function (_previewCollection2) {
        ...
        function Preview(contentType, config, observableUpdater) {
            ...
            _this =
                _previewCollection2.call(
                    this,
                    contentType,
                    config,
                    observableUpdater
                ) || this; // Wait for the tabs instance to mount and the container to be ready

            _this.focusedFaq = _knockout.observable();
            _this.activeFaqTab = _knockout.observable(0);
            _this.events = {
            ...
            _this.buildSlickDebounce = _underscore.debounce(
                _this.buildSlick.bind(_assertThisInitialized(_this)),
                10
            );
            ...
            Promise.all([
                _this.afterChildrenRenderDeferred.promise,
                _this.mountAfterDeferred.promise,
            ]).then(function (_ref) {
                var element = _ref[0],
                ...
                (0, _delayUntil)(
                    function () {
                        ...
                        _this.childSubscribe =
                            _this.contentType.children.subscribe(
                                _this.buildSlickDebounce
                            );
                        _this.previousData =
                            _this.contentType.dataStore.getState();

                        _this.contentType.dataStore.subscribe(function (data) {
                            if (
                                _this.hasDataChanged(_this.previousData, data)
                            ) {
                                _this.buildSlickDebounce();
                            }
                        ...
                        _this.buildSlick(); // Redraw faq after content type gets redrawn
                        ...
                        _events.on("contentType:redrawAfter", function (args) {
                            ...
                            if (
                                args.element &&
                                _this.element &&
                                $element.closest(args.element).length
                            ) {
                                $element.slick("setPosition");
                            }
                        }); // Set the stage to interacting when a faq is focused

                        _this.focusedSlideSubscriber =
                            _this.focusedFaq.subscribe(function (value) {
                                if (value !== null) {
                        ...
                        _events.on(
                            "stage:" +
                                ...
                                ":fullScreenModeChangeAfter",
                            _this.onColumnResize.bind(
                    ...
                    function () {
                        return (
                            (0, _jquery)(element).find(".pagebuilder-faq")
                                .length === expectedChildren
                        );
                    }
                );
            });
        ...
        _proto.retrieveOptions = function retrieveOptions() {
            var options =
                _previewCollection2.prototype.retrieveOptions.call(this);
        ...
        /**
         * Set an active faq for navigation dot
         *
         * @param faqIndex
         */

        _proto.setActiveFaqTab = function setActiveFaqTab(faqIndex) {
            this.activeFaqTab(faqIndex);
        };
        /**
         * Set the focused faq
         *
        ...
        _proto.setFocusedFaq = function setFocusedFaq(faqIndex, force) {
            if (force === void 0) {
                force = false;
            }

            if (force) {
                this.focusedFaq(null);
            }

            this.focusedFaq(faqIndex);
        };
        /**
         * Unset focused faq on focusout event.
         *
        ...
        _proto.onFocusOut = function onFocusOut(data, event) {
            ...
            if (!relatedTarget) {
                this.setFocusedFaq(null);
                return;
            }

            var $relatedTarget = (0, _jquery)(relatedTarget);
            var isRelatedTargetDescendantOfNavigation = $relatedTarget.closest(
                this.navigationElement
            ).length;
            var isFocusedOnAnotherSlideInThisSlider =
                $relatedTarget.hasClass("faq-multiple-tab") &&
        ...
        _proto.afterNavigationRender = function afterNavigationRender(
            navigationElement
        ) {
        ...
        _proto.navigateToFaq = function navigateToFaq(
            faqIndex,
            dontAnimate,
            force
        ) {
            ...
            if ((0, _jquery)(this.element).hasClass("slick-initialized")) {
                (0, _jquery)(this.element).slick(
                    "slickGoTo",
                    faqIndex,
                    dontAnimate
                );
                this.setActiveFaqTab(faqIndex);
                this.setFocusedFaq(faqIndex, force);
            }
        };
        /**
        ...
        _proto.afterChildrenRender = function afterChildrenRender(element) {
            ...
            _previewCollection2.prototype.afterChildrenRender.call(
                this,
                element
            );
        ...
        /**
         * On sort start force the container height, also focus to that faq
         *
         * @param {Event} event
        ...
        _proto.onSortStart = function onSortStart(event, params) {
            ...
            if (
                this.activeFaqTab() !== params.item.index() ||
                this.focusedFaq() !== params.item.index()
            ) {
                this.navigateToFaq(params.item.index(), false, true); // As we've completed a navigation request we need to ensure we don't remove the forced height

                this.contentTypeHeightReset = true;
            }
        };
        /**
         * On sort stop ensure the focused faq and the active faq are in sync, as the focus can be lost in this
         * operation
         */
        ...
        _proto.onSortStop = function onSortStop(event, params) {
            ...
            if (this.activeFaqTab() !== this.focusedFaq()) {
                this.setFocusedFaq(this.activeFaqTab(), true);
            }

            if (params.item.index() !== -1) {
                _underscore.defer(
                    this.focusElement.bind(this, event, params.item.index())
                );
            }
        ...
        /**
         * Add a faq into the slider
         */

        _proto.addFaq = function addFaq() {
            var _this3 = this;

            (0, _contentTypeFactory)(
                _config.getConfig("content_types").scandiweb_faq,
                this.contentType,
                    ...
                    function (args) {
                        if (args.id === faq.id) {
                            _underscore.defer(function () {
                                ...
                                (0, _delayUntil)(
                                    function () {
                                        return _this3.navigateToFaq(
                                            _this3.contentType.children()
                                                .length - 1
                                        );
                                    },
                                    function () {
                            ...
                            _events.off("faq:" + faq.id + ":mountAfter");
                        }
                    },
                    "faq:" + faq.id + ":mountAfter"
                );

                _this3.contentType.addChild(
                    faq,
                    _this3.contentType.children().length
                );
            });
        };
        /**
        ...
        _proto.onControlClick = function onControlClick(index, context, event) {
            ...
            this.navigateToFaq(index);
            this.setFocusedFaq(index);
        };
        /**
         * @inheritdoc
         */
        ...
        _proto.bindEvents = function bindEvents() {
            ...
            }); // Set the active faq to the new position of the sorted faq
            ...
            _events.on("childContentType:sortUpdate", function (args) {
                if (args.instance.id === _this4.contentType.id) {
                    ...
                    _this4.setActiveFaqTab(args.newPosition);

                    _underscore.defer(
                        _this4.focusElement.bind(
                            _this4,
                            args.event,
                            args.newPosition
                        )
            ...
            }); // When a faq content type is removed
            // we need to force update the content of the slider due to KO rendering issues

            var newItemIndex;

            _events.on("faq:removeAfter", function (args) {
                if (
                    args.parentContentType &&
                    args.parentContentType.id === _this4.contentType.id
                ) {
                    // Mark the previous faq as active
            ...
            _events.on("faq:renderAfter", function (args) {
                var itemIndex = args.contentType.parentContentType
                    .getChildren()()
                    .indexOf(args.contentType);

                if (
                    args.contentType.parentContentType.id ===
                        _this4.contentType.id &&
                    newItemIndex !== null &&
                    ...
                    _underscore.defer(function () {
                        if (newItemIndex !== null) {
                            ...
                            _this4.navigateToFaq(itemIndex, true, true);

                            _underscore.defer(function () {
                                _this4.focusedFaq(null);

                                _this4.focusedFaq(itemIndex);
                            });
                        }
                    });
                }
            }); // On a faq content types creation we need to lock the height of the slider to ensure a smooth transition

            _events.on("faq:createAfter", function (args) {
                if (
                    _this4.element &&
                    _this4.ready &&
                    args.contentType.parentContentType.id ===
            ...
            _events.on("slider:dropAfter", function (args) {
                if (
                    args.id === _this4.contentType.id &&
                    _this4.contentType.children().length === 0
                ) {
                    _this4.addFaq();
                }
            ...
            var duplicatedSlide;
            var duplicatedfaqIndex;

            _events.on("faq:duplicateAfter", function (args) {
                if (
                    args.duplicateContentType.parentContentType.id ===
                        _this4.contentType.id &&
                    args.direct
                ) {
                    duplicatedSlide = args.duplicateContentType;
                    duplicatedfaqIndex = args.index;
                }
            });

            _events.on("faq:mountAfter", function (args) {
                if (duplicatedSlide && args.id === duplicatedSlide.id) {
                    _underscore.defer(function () {
                        // Mark the new duplicate faq as active
                        _this4.navigateToFaq(duplicatedfaqIndex, true, true);

                        duplicatedSlide = duplicatedfaqIndex = null;
                    });
                }
            });
        };
        ...
        _proto.buildSlick = function buildSlick() {
            ...
            if (this.element && this.element.children.length > 0) {
                ...
                this.childSubscribe = this.contentType.children.subscribe(
                ...
                (0, _jquery)(this.element).slick(
                    Object.assign(
                        {
                            initialSlide: this.activeFaqTab() || 0,
                        },
                        this.buildSlickConfig()
                    )
                ); // Update our KO pointer to the active faq on change

                (0, _jquery)(this.element)
                    .on(
                        "beforeChange",
                        function (event, slick, currentSlide, nextSlide) {
                            ...
                            _this5.setActiveFaqTab(nextSlide);
                        }
                    )
        ...
        _proto.focusElement = function focusElement(event, index) {
            var handleClassName = (0, _jquery)(event.target).data("ui-sortable")
                .options.handle;
            (0, _jquery)(
                (0, _jquery)(event.target).find(handleClassName)[index]
            ).focus();
        };
        /**
