...
define([
    ...
    "underscore",
    "vimeoWrapper",
    "Magento_PageBuilder/js/content-type-menu/conditional-remove-option",
    ...
    var Preview = /*#__PURE__*/ (function (_preview2) {
        ...
        function Preview() {
            ...
            _this =
                _preview2.call.apply(_preview2, [this].concat(args)) || this;
            _this.buttonPlaceholder = (0, _translate)("Edit Button Text");
            _this.faqName = _knockout.observable();
            _this.isVisible = _knockout.observable(true);
        ...
        _proto.getBackgroundImage = function getBackgroundImage() {
            ...
            var backgroundImage =
                this.viewport() === "mobile" && mobileImage.length
                    ? mobileImage
                    : desktopImage;
        ...
        _proto.afterRenderWysiwyg = function afterRenderWysiwyg(element) {
            ...
            this.contentType.dataStore.subscribe(function () {
                ...
                if (
                    !_this2.wysiwyg ||
                    (_this2.wysiwyg &&
                        _this2.wysiwyg.getAdapter().id !==
                            (0, _editor.getActiveEditor)().id)
                ) {
        ...
        _proto.onMouseOverWrapper = function onMouseOverWrapper() {
            ...
            if (this.data.main.attributes()["data-show-overlay"] === "hover") {
                this.data.overlay.attributes(
                    Object.assign(this.data.overlay.attributes(), {
                        "data-background-color-orig":
                            this.data.overlay.style().backgroundColor,
                    })
                );
                this.data.overlay.style(
                    Object.assign(this.data.overlay.style(), {
                        backgroundColor:
                            this.data.overlay.attributes()[
                                "data-overlay-color"
                            ],
            ...
            if (this.data.main.attributes()["data-show-button"] === "hover") {
                this.data.button.style(
                    Object.assign(this.data.button.style(), {
                        opacity: 1,
                        visibility: "visible",
                    })
                );
        ...
        _proto.retrieveOptions = function retrieveOptions() {
            ...
            delete options.move;
            options.remove = new _conditionalRemoveOption(
                _extends({}, options.remove.config, {
                    preview: this,
                })
            );
            return options;
        ...
        _proto.activateEditor = function activateEditor(preview, event) {
            ...
            if (this.element && !this.wysiwyg) {
                ...
                _underscore.defer(function () {
                    _this3
                        .initWysiwygFromClick(true)
                        .then(function () {
                            return (0, _delayUntil)(
                                function () {
                                    ...
                                    (0, _editor.unlockImageSize)(
                                        _this3.element
                                    );
                                },
                                function () {
                                    return _this3.element.classList.contains(
                                        "mce-edit-focus"
                                    );
                                },
                                10
        ...
        _proto.initTextarea = function initTextarea(element) {
            ...
            _events.on(
                "form:" + this.contentType.id + ":saveAfter",
                function () {
                    _this5.textarea.value =
                        _this5.contentType.dataStore.get("content");
        ...
        _proto.onTextareaFocus = function onTextareaFocus() {
            (0, _jquery)(this.textarea)
                .closest(".pagebuilder-content-type")
                ...
                wysiwygConfig.adapter.settings.init_instance_callback =
                    function (editor) {
                        editor.on("blur", function () {
                            (0,
                            _nestingLinkDialog)(_this6.contentType.dataStore, _this6.wysiwyg, "content", "link_url");
                            (0,
                            _nestingWidgetDialog)(_this6.contentType.dataStore, _this6.wysiwyg, "content", "link_url");
                        });
        ...
        _proto.bindEvents = function bindEvents() {
            ...
            this.contentType.dataStore.subscribe(function (state) {
                ...
                _editor.removeReservedHtmlAttributes)(state.content);
            ...
            _events.on("childContentType:sortUpdate", function (args) {
                if (
                    args.instance.id === _this8.contentType.parentContentType.id
                ) {
                    _this8.wysiwyg = null;
                }
            });
            ...
            _events.on(this.config.name + ":mountAfter", function (args) {
                if (args.id === _this8.contentType.id) {
                    ...
                    var faqMultipleTabs = _this8.contentType.parentContentType;
                    ...
                    _this8.displayLabel(
                        (0, _translate)(
                            "FAQ " +
                                (faqMultipleTabs
                                    .children()
                                    .indexOf(_this8.contentType) +
                                    1)
                        )
                    );

                    if (!faqMultipleTabs.preview?.activeFaqTab) {
                        _this8.isVisible(true);

                        return;
                    }

                    faqMultipleTabs.preview.activeFaqTab.subscribe(
                        (activeId) => {
                            if (
                                activeId ===
                                faqMultipleTabs
                    ...
                    faqMultipleTabs.children.subscribe(function (children) {
            ...
            _events.on(this.config.name + ":renderAfter", function (args) {
                if (args.id === _this8.contentType.id) {
                    ...
                    (0, _jquery)(slider.preview.element).on(
                        "beforeChange",
                        function () {
                    ...
                    (0, _jquery)(slider.preview.element).on(
                        ...
                        function (event, slick) {
                            (0, _jquery)(slick.$slides).each(function (
                                index,
                                slide
                            ) {
                                var videoSlide =
                                    slide.querySelector(".jarallax");
            ...
            this.contentType.dataStore.subscribe(function (data) {
                _this8.faqName(data.faq_tab_name || "FAQ tab name");
            });
        };
        /**
        ...
        _proto.changeUploaderControlsVisibility =
            function changeUploaderControlsVisibility() {
                var _this9 = this;
        ...
        _proto.adjustTextareaHeightBasedOnScrollHeight =
            function adjustTextareaHeightBasedOnScrollHeight() {
